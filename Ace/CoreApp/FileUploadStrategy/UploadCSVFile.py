...
class UploadCSV(interface_UploadFile.UploadFile):
    ...
    def dopreProcessing(self, map_col_obj):
        ...
        self.df = pd.read_csv('CoreApp/UploadedFiles/'+self.file_name)
    ...
    def uploadFile(self):
        ...
        cursor = conn.cursor() 
        stmt= ('INSERT INTO "CoreApp_farmerinfo" (first_name,last_name,state_name,district_name,village_name,phone)'"VALUES (%s,%s,%s,%s,%s,%s)")
